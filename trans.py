...
#### Buttons
but1 = Button(screen,text='Translate',bd=6, bg='white',activebackground='yellow',width=8,font=('arial',15,'bold') )
but1.place(x=70,y=170)

but2 = Button(screen,text='Exit',bd=6, bg='white',activebackground='yellow',width=8,font=('arial',15,'bold') )
